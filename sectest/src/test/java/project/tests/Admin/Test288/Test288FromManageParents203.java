...
public class Test288FromManageParents203 extends AdminBaseTest { 
    ...
    public void test() {
        ...
        assertTrue("ERROR: Title doesn't match",utils.isTitleEqualsTo(manageParentsTitle));
